...
Данно: координаты городов. Первый действием записал координат каждого города в отдельные переменные. Расчитал расстояний между каждыми городами по формуле. С помощью round() окргуглил до 2 знаков после запятой. Сформировал словарь расстояния от одного города до двух других.
