...
2. Создал 3 функции с расчетом площади, радиуса описанной и вписанной окружности сохранил вычисления в глобальных переменных. Функция save_all создает word файл и сохраняет туда расчеты с глобальных переменных. Для каждой фигуры создал графический пользовательский интерфейс на appJar.
